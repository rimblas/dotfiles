...
var sql="select ID, TIME_STAMP, LOGGER_LEVEL, TEXT, SCOPE, MODULE, ACTION, USER_NAME, CLIENT_IDENTIFIER, CLIENT_INFO, CALL_STACK, UNIT_NAME, LINE_NO, SCN, SID, to_char(EXTRA) EXTRA from logger_logs_5_min where id=";
